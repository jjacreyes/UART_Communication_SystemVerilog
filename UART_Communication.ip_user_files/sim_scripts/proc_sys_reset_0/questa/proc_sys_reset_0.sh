...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="W:/Desktop/SystemVerilogLabs/Lab6_7_ELEC3500/UART_Communication/UART_Communication_SystemVerilog/UART_Communication.cache/compile_simlib/questa"
  fi
