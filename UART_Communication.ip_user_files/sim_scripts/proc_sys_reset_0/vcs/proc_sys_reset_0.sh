...
#
# Script generated by Vivado on Tue Feb 24 11:50:57 -0500 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : proc_sys_reset_0.sh
...
#
# Usage        : proc_sys_reset_0.sh
#                proc_sys_reset_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                proc_sys_reset_0.sh [-reset_run]
#                proc_sys_reset_0.sh [-reset_log]
#                proc_sys_reset_0.sh [-help]
#
...
#                script (type 'proc_sys_reset_0.sh -help' for more information).
#
...
# script info
echo -e "proc_sys_reset_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./proc_sys_reset_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.proc_sys_reset_0 xil_defaultlib.glbl -o proc_sys_reset_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./proc_sys_reset_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key proc_sys_reset_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc proc_sys_reset_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./proc_sys_reset_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: proc_sys_reset_0.sh [-help]\n\
Usage: proc_sys_reset_0.sh [-step]\n\
Usage: proc_sys_reset_0.sh [-lib_map_path]\n\
Usage: proc_sys_reset_0.sh [-reset_run]\n\
Usage: proc_sys_reset_0.sh [-reset_log]\n\
Usage: proc_sys_reset_0.sh [-keep_index]\n\
Usage: proc_sys_reset_0.sh [-noclean_files]\n\n\
