...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../UART_Communication.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../UART_Communication.gen/sources_1/ip/clk_wiz_0" \
