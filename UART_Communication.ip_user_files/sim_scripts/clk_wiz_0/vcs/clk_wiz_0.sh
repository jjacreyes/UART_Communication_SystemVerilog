...
#
# Script generated by Vivado on Tue Feb 24 11:45:40 -0500 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../UART_Communication.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../UART_Communication.gen/sources_1/ip/clk_wiz_0" \
