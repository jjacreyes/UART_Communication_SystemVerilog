...
HD_PWD='W:/Desktop/SystemVerilogLabs/Lab6_7_ELEC3500/UART_Communication/UART_Communication_SystemVerilog/UART_Communication.runs/proc_sys_reset_0_synth_1'
cd "$HD_PWD"
